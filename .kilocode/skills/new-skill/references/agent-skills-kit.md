# Agent Skills Kit — Project Config (KiloCode)
...
5. **Audit entire .kilocode folder** — "scan and fix my .kilocode structure"

## Skill Folder Convention

Skills live in `.kilocode/skills/<skill-name>/SKILL.md`. KiloCode also supports mode-specific skills in `skills-code/`, `skills-architect/`, `skills-debug/`, etc.
...
- KiloCode also reads `.claude/skills/` as fallback
